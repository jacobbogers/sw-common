<div
  class="flx min-size-auto>* flx-nowrap flx-column h-full overflow-auto relative sign-layout-bg"
>
  <header
  ...
  >
        ...
        ><svg
          ...
          ></path><defs
            ><linearGradient
              ...
              ><stop stop-color="#E3D9FF"></stop><stop
                offset="1"
                stop-color="#7341FF"
              ></stop></linearGradient
            ><linearGradient
              ...
              y2="-3.075"
              gradientUnits="userSpaceOnUse"
              ><stop offset=".271" stop-color="#E3D9FF"></stop><stop
                offset="1"
                stop-color="#7341FF"
              ></stop></linearGradient
            ><radialGradient
              ...
              gradientUnits="userSpaceOnUse"
              ><stop offset=".556" stop-color="#6D4AFF"></stop><stop
                offset=".994"
                stop-color="#AA8EFF"
              ></stop></radialGradient
            ></defs
    ...
    <div>
      <button
        ...
        ><span class="text-ellipsis" lang="en">English</span><svg
          viewBox="0 0 16 16"
          class="icon-size-4 shrink-0 ml-1"
          role="img"
          focusable="false"
          aria-hidden="true"
          ><use xlink:href="#ic-chevron-down-filled"></use></svg
        ></button
      >
    </div>
  </header>
  <div class="p-0 sm:px-6 flex flex-nowrap flex-column justify-space-between">
    <main class="">
      <div
          ...
          <form name="loginForm" data-testid="login-form" method="post">
                ...
                >
                  ...
                  >
                    <button
                      ...
                      ><svg
                        viewBox="0 0 16 16"
                        class="icon-size-4 m-auto"
                        role="img"
                        focusable="false"
                        aria-hidden="true"><use xlink:href="#ic-eye"></use></svg
                      ></button
                    >
                  </div>
                </div>
              ...
              <label
                ...
                /><span class="checkbox-fakecheck"
                  ><svg
                    ...
                    focusable="false"
                    aria-hidden="true"
                    ><use xlink:href="#ic-checkmark"></use></svg
                  ></span
                ></label
              >
              <div class="flex-1">
                ...
                <div class="color-weak">
                  Recommended on trusted devices. <a
            ...
            <div class="text-center mt-4">
              New to Proton? <a
                ...
                href="/mail/signup">Create account</a
              >
            </div>
            <hr class="my-4" />
            <div class="text-center">
              <button
                ...
                aria-expanded="false"
                aria-describedby="dropdown-6">Trouble signing in?</button
              >
            </div>
          </form>
        </div>
            ...
            <svg
              ...
              ></path><defs
                ><radialGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                  ><stop offset=".503" stop-color="#6D4AFF"></stop><stop
                    offset=".994"
                    stop-color="#06B8FF"
                  ></stop></radialGradient
                ><linearGradient
                  ...
                  y2="-2.692"
                  gradientUnits="userSpaceOnUse"
                  ><stop stop-color="#BFE8FF"></stop><stop
                    offset=".307"
                    stop-color="#BFABFF"
                  ></stop><stop offset="1" stop-color="#7341FF"
                  ></stop></linearGradient
                ></defs
              ></svg
            >
            ...
            <svg
              ...
              ></path><defs
                ...
                ><linearGradient
                  ...
                  y2="32.431"
                  gradientUnits="userSpaceOnUse"
                  ><stop stop-color="#7341FF"></stop><stop
                    offset=".359"
                    stop-color="#B487FF"
                  ></stop><stop offset="1" stop-color="#FFC8FF"
                  ></stop></linearGradient
                ></defs
              ></svg
            >
            ...
            <svg
              ...
              ></path><defs
                ><linearGradient
                  ...
                  y2="-1.922"
                  gradientUnits="userSpaceOnUse"
                  ><stop offset=".066" stop-color="#8EFFEE"></stop><stop
                    offset=".45"
                    stop-color="#C9C7FF"
                  ></stop><stop offset="1" stop-color="#7341FF"
                  ></stop></linearGradient
                ><linearGradient
                  ...
                  y2="31.512"
                  gradientUnits="userSpaceOnUse"
                  ><stop offset=".48" stop-color="#6D4AFF"></stop><stop
                    offset=".994"
                    stop-color="#00F0C3"
                  ></stop></linearGradient
                ></defs
            ...
            <svg
              ...
              ></path><defs
                ><radialGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                  ><stop stop-color="#FFD580"></stop><stop
                    offset=".09"
                    stop-color="#F6C592"
                  ></stop><stop offset=".2" stop-color="#EBB6A2"></stop><stop
                    offset=".32"
                    stop-color="#DFA5AF"
                  ></stop><stop offset=".43" stop-color="#D397BE"></stop><stop
                    offset=".53"
                    stop-color="#C486CB"
                  ></stop><stop offset=".65" stop-color="#B578D9"></stop><stop
                    offset=".77"
                    stop-color="#A166E5"
                  ></stop><stop offset=".89" stop-color="#8B57F2"></stop><stop
                    offset="1"
                    stop-color="#704CFF"
                  ></stop></radialGradient
                ><linearGradient
                  ...
                  y2="31.68"
                  gradientUnits="userSpaceOnUse"
                  ><stop stop-color="#6D4AFF"></stop><stop
                    offset=".39"
                    stop-color="#B39FFB"
                    stop-opacity=".98"
                  ></stop><stop
            ...
            <svg
              ...
              ></path><defs
                ><linearGradient
                  ...
                  y2="22.1686"
                  gradientUnits="userSpaceOnUse"
                  ><stop stop-color="#957AFD"></stop><stop
                    offset="1"
                    stop-color="#FFC6C6"
                  ></stop></linearGradient
                ><linearGradient
                ...
                ><linearGradient
                  ...
                  ></stop><stop offset="0.720842" stop-color="#FF8065"
                  ></stop><stop offset="1" stop-color="#FFA51F"
                  ></stop></linearGradient
                ><linearGradient
                  id="logo-12-d"
                  x1="24.8427"
    ...
    <div class="text-center m-0 pt-4 pb-0 sm:pb-4 shrink-0">
      <span class="block sm:inline"
        ><a
          ...
          target="_blank"
          rel="noopener noreferrer nofollow"
          class="signup-link link-focus">Terms</a
        ></span
      ...
      ><span class="block sm:inline"
        ><a
          ...
          target="_blank"
          rel="noopener noreferrer nofollow"
          class="signup-link link-focus old-link">Privacy policy</a
        ></span
      ><span class="color-border px-2 hidden sm:inline" aria-hidden="true"
        >|</span
      ><span class="hidden sm:inline">Version 5.0.248.0</span>
    </div>
  </footer>
  <div
  ...
  >
    <a
      href="https://proton.me/support/common-login-problems"
      target="_blank"
      rel="noopener noreferrer nofollow"
      class="signup-link link-focus">Help</a
    >
  </div>
  <p
    data-testid="layout-footer:version-text"
    class="block sm:hidden text-center text-sm m-2 mb-4"
  >
    Version 5.0.248.0
  </p>
</div>
