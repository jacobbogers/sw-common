...
>
  <div class="inline-flex flex-nowrap shrink-0">
    <a
      ...
      class="shrink-0 relative rounded-(--border-radius-md)"
      ><svg
  ...
  <div>
    <button
      class="button button-small button-ghost-norm flex items-center flex-nowrap text-nowrap mr-custom"
      aria-busy="false"
      ...
      ><span class="text-ellipsis" lang="en">English</span><svg
        viewBox="0 0 16 16"
        class="w-4 h-4 fill-current align-middle inline-block shrink-0 ml-1"
        role="img"
        focusable="false"
        aria-hidden="true"><use xlink:href="#ic-chevron-down-filled"></use></svg
      ></button
    >
  </div>
</header>
